...
ネットアップアカウント1つにつきCloud Volumes ONTAP システムの最大数に制限されます。 https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-licensing.html#max-number-of-systems["この制限の詳細については、こちらをご覧ください"^]
